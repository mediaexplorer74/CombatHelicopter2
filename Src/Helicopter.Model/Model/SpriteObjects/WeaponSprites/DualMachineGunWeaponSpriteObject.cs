...
// Type: Helicopter.Model.SpriteObjects.WeaponSprites.DualMachineGunWeaponSpriteObject
...
{
  internal class DualMachineGunWeaponSpriteObject : WeaponSpriteObject
  {
    public override void Init(SpriteObject parent, Weapon weapon)
    {
      ...
      this.TexturePath = "GameWorld/Objects/Weapon/weaponS1_2";
