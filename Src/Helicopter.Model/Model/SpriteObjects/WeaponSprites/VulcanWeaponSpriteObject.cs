...
// Type: Helicopter.Model.SpriteObjects.WeaponSprites.VulcanWeaponSpriteObject
...
{
  internal class VulcanWeaponSpriteObject : WeaponSpriteObject
  {
    public override void Init(SpriteObject parent, Weapon weapon)
    {
      ...
      this.TexturePath = "GameWorld/Objects/Weapon/weaponS1_3";
