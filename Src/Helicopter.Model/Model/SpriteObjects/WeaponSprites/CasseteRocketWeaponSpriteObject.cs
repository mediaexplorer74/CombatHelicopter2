...
// Type: Helicopter.Model.SpriteObjects.WeaponSprites.CasseteRocketWeaponSpriteObject
...
{
  internal class CasseteRocketWeaponSpriteObject : WeaponSpriteObject
  {
    public override void Init(SpriteObject parent, Weapon weapon)
    {
      this.Offset = weapon.BaseWeaponPosition;
      this.TexturePath = "GameWorld/Objects/Weapon/weaponS2_5";
