...
// Type: Helicopter.Model.SpriteObjects.WeaponSprites.HominRocketWeaponSpriteObject
...
{
  internal class HominRocketWeaponSpriteObject : WeaponSpriteObject
  {
    public override void Init(SpriteObject parent, Weapon weapon)
    {
      ...
      this.TexturePath = "GameWorld/Objects/Weapon/weaponS2_3";
